                ...
                <AccordionDetails className={classes.details}>
                    <div className={classes.mycolumn}>
                        <div className="flex flex-col justify-center">
                            ...
                            <TextFieldFormsy className="mb-16" type="text" name="suffix" label="Suffix" 
                            validations={{
                                minLength: 2,
                                maxLength: 2,
                                isAlpha: true
                            ...
                            validationErrors={{
                                minLength: 'The length of the suffix is exactly 2',
                                maxLength: 'The length of the suffix is exactly 2',
                                isAlpha: 'You need to provide two letters for the suffix'
                            }}
                            required
                            />
