...
const base = '/statuses';
const categoryTitle = 'Product Statuses';
const elementTitle = 'Status';
	...
	routes: [
		{
			...
			component: () => {
				...
				customBreadcrumbs.push({title: 'Create Product Status'});
		...
		},
		{
			...
			component: () => {
				...
				customBreadcrumbs.push({to: base, title: categoryTitle });
				customBreadcrumbs.push({title: 'Edit Product Status'})

				return <Details title="Edit Product Status" breadcrumbs={customBreadcrumbs}>
