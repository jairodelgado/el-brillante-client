...
const categoryTitle = 'Materials';
const elementTitle = 'Material';
	...
	routes: [
		{
			...
			component: () => {
				...
				customBreadcrumbs.push({title: 'Create Material'});
		...
		},
		{
			...
			component: () => {
				...
				customBreadcrumbs.push({to: base, title: categoryTitle });
				customBreadcrumbs.push({title: 'Edit Material'})

				return <Details title="Edit Material" breadcrumbs={customBreadcrumbs}>
