	...
	routes: [
		{
			...
			component: () => {
				...
				customBreadcrumbs.push({title: 'Create Item'});
		...
		},
		{
			...
			component: () => {
				...
				customBreadcrumbs.push({to: base, title: categoryTitle });
				customBreadcrumbs.push({title: 'Edit Item'})

				return <Details title="Edit Item" breadcrumbs={customBreadcrumbs}>
