...
const base = '/stores';
const categoryTitle = 'Stores';
const elementTitle = 'Store';
const breadcrumbs = [{
	to: '/',
	title: 'Home'
}];
	...
	routes: [
		{
			...
			component: () => {
				...
				customBreadcrumbs.push({title: 'Create Store'});

				return <Create of={base} categoryTitle={categoryTitle} elementTitle={elementTitle} breadcrumbs={customBreadcrumbs} edition><Fields /></Create>;
			}
		},
		{
			...
			component: () => {
				...
				customBreadcrumbs.push({to: base, title: categoryTitle });
				customBreadcrumbs.push({title: 'Edit Store'})

				return <Details title="Edit Store" breadcrumbs={customBreadcrumbs}>
