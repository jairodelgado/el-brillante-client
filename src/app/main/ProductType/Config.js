...
const categoryTitle = 'Product Types';
	...
	routes: [
		{
			...
			component: () => {
				...
				customBreadcrumbs.push({title: 'Create Product Type'});
		...
		},
		{
			...
			component: () => {
				...
				customBreadcrumbs.push({to: base, title: categoryTitle });
				customBreadcrumbs.push({title: 'Edit Product Type'})

				return <Details title="Edit Product Type" breadcrumbs={customBreadcrumbs}>
